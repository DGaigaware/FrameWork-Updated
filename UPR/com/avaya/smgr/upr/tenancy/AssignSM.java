...
public void Verify_Assigned_Elements() throws Exception
{
	...
	action.EntertextUsingKey(locator.getProperty("Loginname"),input.getProperty("UPRCMSMLoginname"),Keys.TAB);
	wait.until(ExpectedConditions.textToBePresentInElementValue(By.xpath(locator.getProperty("Loginname")),input.getProperty("UPRCMSMLoginname")));
