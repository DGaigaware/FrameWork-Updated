...
public class EnableReplication {
	...
	public void Verify_GR_Health_on_Primary() throws Exception
	{
	   ...
	   // Verify the status is Running
		...
		Assert.assertEquals(str, "Running");
		for(int i=2;i<4;i++)
		{
            ...
            String str2=action.driver.findElement(By.xpath(".//*[@id='tblServiceStatus_core_table_content']/tbody/tr[5]/td[2]/span")).getAttribute("title");
            Assert.assertEquals(str2, "Running");
	}
