...
public class AdDemo25082015 {
	...
	public static void demoAdd() throws IOException, InterruptedException, ParserConfigurationException, SAXException {
		...
		driver.findElement(By.xpath(".//*[@id='vmname-inputEl']")).sendKeys(obj.readFromFile("inputbsm.txt", "VMName225"));
		...
		obj.boundListSelect(driver, "data", obj.selBoundList(driver));
					...
					driver.findElement(By.xpath(".//*[@id='textfield-1228-inputEl']")).sendKeys(obj.readFromFile("input.txt", "BSMFilePath"));
