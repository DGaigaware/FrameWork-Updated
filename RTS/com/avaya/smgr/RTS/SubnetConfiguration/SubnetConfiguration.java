...
@Test(description="Verification of subnet is added successfully",groups={"Sanity"})
...
@Test(description="Verification of subnet is Updated successfully",dependsOnMethods="SubnetConfigAdd",groups={"Sanity"})
...
@Test(description="Verification of subnet is deleted successfully",dependsOnMethods="SubnetConfigUpdate",groups={"Sanity"})
