...
public class refreshdemo0810 {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
		...
		Thread.sleep(1000);
		obj.checkSuccessOrFailure(drive, By.id("vmDeployStatus"),"test"+shortVMName, 8, true);
		...
		obj.checkSuccessOrFailure(drive, By.id("vmDeployStatus"),"test"+ shortVMName, 50, true);		
