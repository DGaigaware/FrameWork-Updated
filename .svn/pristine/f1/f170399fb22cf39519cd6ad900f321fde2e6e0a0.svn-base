...
@Test(description="Verify the Creation of new user by assigning Upr with CM and SM element",enabled=false)
...
action.SelectFromdropDown(locator.getProperty("Users.Uprdropdown"), input.getProperty("uprcmsm"));
...
String str1=new Select(action.driver.findElement(By.xpath(locator.getProperty("Users.smlist")))).getFirstSelectedOption().getText();
...
String str3=new Select(action.driver.findElement(By.xpath(locator.getProperty("Upr.cmlist")))).getFirstSelectedOption().getText();
Assert.assertEquals(str3,input.getProperty("cm29"));
String str4=new Select(action.driver.findElement(By.xpath(locator.getProperty("Upr.templatelist")))).getFirstSelectedOption().getText();
Assert.assertEquals(str4,input.getProperty("Template"));
