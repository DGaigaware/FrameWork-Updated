...
@Test(description="Verify that the commit and cancel buttons are enabled",priority=1)
...
@Test(description="Verify thate the Collapse functionality for the page",priority=2)
...
@Test(description="Verify thate the Expand functionality for the page",priority=3)
