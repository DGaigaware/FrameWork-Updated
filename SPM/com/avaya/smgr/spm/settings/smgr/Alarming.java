...
@Test(description="Eanable of commit and cancel buttons",priority=1)
...
@Test(description="Showing/Hiding behaviour of Alarm Sevirity Levels",priority=1)
...
@Test(description="Showing/Hiding behaviour of AutoFresh",priority=1)
...
@Test(description="Collapse functionality of Alarming UI",priority=1)
...
@Test(description="Expand functioanality of Alarming UI",priority=1)
...
@Test(description="Alaming UI name on UI",priority=1)
...
@Test(description="Verify that the errror message should display when Interminate field is missed",priority=1)
...
@Test(description="Verify that the errror message should display when Minor field is empty",priority=1)
...
@Test(description="Verify that the errror message should display when Warning field is empty",priority=1)
...
@Test(description="Verify that the errror message should display when Time field is empty",priority=1)
